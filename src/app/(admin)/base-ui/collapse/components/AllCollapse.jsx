      ...
      <Card>
        ...
        <CardBody>
          ...
          <div className="hstack gap-2">
            <Link onClick={toggle} className="btn btn-primary mb-2" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
              Link with href
            </Link>
      ...
      <Card>
        ...
        <CardBody>
          <div className="hstack gap-2 mb-3">
            <Link onClick={toggleFirst} className="btn btn-primary" data-bs-toggle="collapse" href="#multiCollapseExample1" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">
